  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.title}>Чат в разработке</Text>
        <Text style={styles.sub}>room id: {id}</Text>
        <Text style={styles.hint}>Здесь будет Supabase Realtime чат: текст, фото, файлы.</Text>
      </View>
    </SafeAreaView>
  );
}
