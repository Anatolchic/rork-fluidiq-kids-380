      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.inner}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity style={[styles.btnPrimary, (!agreed || (minorMode && !parentAgreed)) && { opacity: 0.5 }]} onPress={handleRegister} disabled={loading}>
...
const styles = StyleSheet.create({
  ...
  form: { gap: 12 },
  label: { fontSize: 12, color: COLORS.textSecondary, fontWeight: '600', marginTop: 4 },
  ...
  minorBox: { padding: 14, backgroundColor: COLORS.warning + '15', borderRadius: 12, borderWidth: 1, borderColor: COLORS.warning + '40', gap: 10, marginTop: 4 },
  minorTitle: { fontSize: 14, fontWeight: '700', color: COLORS.warning },
